...
detection_model_path = '../model/opencv/haarcascade_frontalface_default.xml'
...
while True:
    ...
    for face_coordinates in faces:
        ...
        cv2.putText(rgb_image, emotion_text, (x1, y1), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0), 2, cv2.LINE_AA)
